...
public class MessageControllerTest {
  ...
  public synchronized void testSingleDeviceCurrent() throws Exception {
    ...
    verify(pushSender, times(1)).sendMessage(any(Account.class), any(Device.class), any(Envelope.class), eq(false), anyString());
  }
  ...
  public synchronized void testMultiDevice() throws Exception {
    ...
    verify(pushSender, times(2)).sendMessage(any(Account.class), any(Device.class), any(Envelope.class), eq(false), anyString());
  }
